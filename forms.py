...
class RatingForm(forms.Form):
    ...
    rating_author = forms.CharField(label=_('Rating_Author'),required=False,max_length=150, strip=True)
    comment = forms.CharField(label=_('Rating_Comment'),max_length=1500,required = False, strip=True, widget=forms.Textarea)
