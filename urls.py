...
urlpatterns = [
    ...
    path('learningTopicSoftwares/', views.learningTopicSoftwares, name='softwareTopics'),
    ...
    path('learningTopicGuides/', views.learningTopicGuides, name='learningTopicGuides'),
